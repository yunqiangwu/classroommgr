...
import tk.mybatis.springboot.websocket.Greeting;
...
public class GreetingController {
    ...
    @SendToUser("/message")
    public Greeting handleSubscribe(Principal principal) {
    ...
    public Greeting send(@RequestParam String uid) {
        simpMessageSendingOperations.convertAndSendToUser(uid, "/message", new Greeting("I am a msg from SubscribeMapping('/macro')."));
        return new Greeting("I am a msg from SubscribeMapping('/macro').");
    }
